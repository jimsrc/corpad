...
lambda_ratio    = MFPs_perp/MFPs_parall
parall_o_larmor = MFPs_parall/RLs

ax.plot(parall_o_larmor, lambda_ratio, '-o', c='black', label='simulations')
...
ax.set_xlabel('$\lambda_\parallel / R_L$', fontsize=19.)
