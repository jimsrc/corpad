...
fname_theoryParall= '%s/mfpParall.vs.SlabPerc/mfp.profiles/xminSlab.1.0e-06_xmaxSlab1.0e+05_xmin2d.1.0e-04_xmax2d.1.0e+03/mfp.ParallCompos_R.%1.4f_sig%1.2f_Lc2D.%1.1e_LcSlab.%1.1e.dat' % (dir_theory, R, sig, Lc_2d, Lc_slab)
fname_theoryPerp= '%s/mfpPerp.vs.SlabPerc/mfp.profiles/xminSlab.1.0e-06_xmaxSlab1.0e+05_xmin2d.1.0e-04_xmax2d.1.0e+03/mfp.PerpCompos_R.%1.4f_sig%1.2f_Lc2D.%1.1e_LcSlab.%1.1e.dat' % (dir_theory, R, sig, Lc_2d, Lc_slab)
...
theory_slabs	= data_theoryParall[0] # [1]
...
ax.plot(perc_slabs[1:], MFPs_perp[1:]/MFPs_parall[1:], '-o', c='black', label='simulations')
ax.plot(theory_slabs, theory_mfpPerp/theory_mfpParall, '-', c='blue', label='WNLT approximation')
...
fname_fig       = '%s/mfpRatio.vs.Slabs_Lc2d.%1.1e_LcSlab.%1.1e_sig.%1.2f_Nm%03d_sig.%1.1e_R.%1.1e.png' % (dir_figs, Lc_2d, Lc_slab, sig, Nm, sig, R)
