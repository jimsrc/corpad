...
set xrange [ -298.020 : 40499.7 ] noreverse nowriteback
set x2range [ 2.39298 : 4.07837 ] noreverse nowriteback
set ylabel "" 
set ylabel  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set y2label "" 
set y2label  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set yrange [ 1.10454e+18 : 1.05933e+19 ] noreverse nowriteback
set y2range [ 18.4940 : 19.0032 ] noreverse nowriteback
set zlabel "" 
...
GNUTERM = "wxt"
pl 'k_vs_t_Ek.6.0e+05eV_slab1.0_LcShalchi04_50Brlzs.dat' u 1:(($2+$3)/2.) ti "50", 'k_vs_t_Ek.6.0e+05eV_slab1.0_LcShalchi04_25Brlzs.dat' u 1:(($2+$3)/2.) ti "25", 'k_vs_t_Ek.6.0e+05eV_slab1.0_LcShalchi04_10Brlzs.dat' u 1:(($2+$3)/2.) ti "10"
#    EOF
