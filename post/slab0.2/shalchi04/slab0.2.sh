...
set xrange [ -486.359 : 40550.2 ] noreverse nowriteback
set x2range [ -471.683 : 40550.0 ] noreverse nowriteback
set ylabel "" 
set ylabel  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set y2label "" 
set y2label  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set yrange [ 2.75630e+18 : 5.83641e+18 ] noreverse nowriteback
set y2range [ 2.80316e+18 : 5.58213e+18 ] noreverse nowriteback
set zlabel "" 
...
GNUTERM = "wxt"
pl 'k_vs_t_Ek.6.0e+05eV_slab0.2_LcShalchi04_50Brlzs.dat' u 1:(($2+$3)/2.) ti "50", 'k_vs_t_Ek.6.0e+05eV_slab0.2_LcShalchi04_25Brlzs.dat' u 1:(($2+$3)/2.) ti "25", 'k_vs_t_Ek.6.0e+05eV_slab0.2_LcShalchi04_10Brlzs.dat' u 1:(($2+$3)/2.) ti "10"
#    EOF
