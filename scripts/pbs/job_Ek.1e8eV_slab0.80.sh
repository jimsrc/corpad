...
cd $THIS_DIR
INPUTS="../inputs/TURB_sig1e+0_Nm128_slab.0.80.in ../inputs/orientations_isotropic_Nth16_Nph8.in ../inputs/GRAL_Ek.1e8eV_alone_nB50.in"
NAMES_NODES="-machinefile ./names_1e8eV_slab0.80"
DIR_OUTPUT="../output/output_Ek.1.0e+08eV/slab0.80"
