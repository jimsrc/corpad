...
cd $THIS_DIR
INPUTS="../inputs/INPUT_TURB.Nm1.inp ../inputs/orientations_isotropic.inp ../inputs/INPUT_GRAL_Ek.1e6.inp"
NAMES_NODES="-machinefile ./names.list_Nm1"
DIR_OUTPUT="../output/output_Ek.1e6eV/Nm1"
MON1=$THIS_DIR/mon1_1e6eV_Nm1.log
MON2=$THIS_DIR/mon2_1e6eV_Nm1.log
NPROCS="-np 24"
