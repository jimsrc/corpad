...
cd $THIS_DIR
INPUTS="../inputs/INPUT_TURB.Nm2.inp ../inputs/orientations_isotropic.inp ../inputs/INPUT_GRAL_Ek.1e9.inp"
NAMES_NODES="-machinefile ./names.list_Nm2"
DIR_OUTPUT="../output/output_Ek.1e9eV/Nm2"
MON1=$THIS_DIR/mon1_1e9eV_Nm2.log
MON2=$THIS_DIR/mon2_1e9eV_Nm2.log
NPROCS="-np 24"
