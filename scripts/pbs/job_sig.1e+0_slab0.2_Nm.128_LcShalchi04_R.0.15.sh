...
cd $THIS_DIR
INPUTS="../inputs/TURB_sig1e+0_Nm128_slab.0.2_LcShalchi04.in ../inputs/orientations_isotropic_Nth16_Nph8.in ../inputs/GRAL_R.0.15.in"
NAMES_NODES="-machinefile ./nodes_R.0.15"
DIR_OUTPUT="../output/R_0.15"
