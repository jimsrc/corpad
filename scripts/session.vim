...
set shortmess=aoO
badd +0 test.sh
badd +0 ~/simulacion/pla_stochastic/composite_turbulence/massive_orbits/inputs/INPUT_TURB.ALONE.inp
args test.sh
edit test.sh
...
exe 'vert 1resize ' . ((&columns * 73 + 71) / 142)
exe 'vert 2resize ' . ((&columns * 68 + 71) / 142)
argglobal
