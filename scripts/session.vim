...
silent only
cd ~/simulacion/pla_stochastic/composite_turbulence/massive_orbits/scripts
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +8 test.sh
badd +1 ~/simulacion/pla_stochastic/composite_turbulence/massive_orbits/inputs/INPUT_TURB.ALONE.inp
badd +0 ~/simulacion/pla_stochastic/composite_turbulence/massive_orbits/inputs/INPUT_GRAL.xx1.inp
args test.sh
edit test.sh
...
exe 'vert 1resize ' . ((&columns * 76 + 73) / 147)
exe 'vert 2resize ' . ((&columns * 70 + 73) / 147)
argglobal
...
wincmd w
argglobal
edit ~/simulacion/pla_stochastic/composite_turbulence/massive_orbits/inputs/INPUT_TURB.ALONE.inp
xnoremap <buffer> <silent> \a} `>a}`<i{
xnoremap <buffer> <silent> \a{ `>a}`<i{
xnoremap <buffer> <silent> \a) `>a)`<i(
xnoremap <buffer> <silent> \a( `>a)`<i(
...
exe 'vert 1resize ' . ((&columns * 76 + 73) / 147)
exe 'vert 2resize ' . ((&columns * 70 + 73) / 147)
tabedit ~/simulacion/pla_stochastic/composite_turbulence/massive_orbits/inputs/INPUT_GRAL.xx1.inp
set splitbelow splitright
wincmd t
set winheight=1 winwidth=1
argglobal
