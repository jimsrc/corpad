...
for i in range(n):
	perc_slab	= SLABs[i]
	dir_data    = '%s/output/Ek.%1.1eeV/Nm%03d/slab%1.2f/sig.%1.1e/Lc2D.%1.1e_LcSlab.%1.1e' % (PLAS, Ek, Nm, perc_slab, sig, Lc_2d, Lc_slab)
	t_decr		= 800 #TDECRs[i]  #200#200 #500 # 1000
	kperp[i] 	= fit_kperp_asintot(Ek, dir_data, t_decr, dir_out, dir_plot)
