...
silent only
cd ~/simulacion/pla_stochastic/composite_turbulence/massive_orbits/scripts/analyze_err/rtol
...
badd +1 gg.py
badd +54 funcs.py
badd +53 calc_kperp.py
badd +18 massive_kperp.py
badd +138 calc_k.py
badd +9 massive.py
badd +1 build_massive_k.profiles.py
badd +16 _calc_k_vs_t.py
badd +183 calc_k_vs_t.py
...
silent! normal! zE
let s:l = 17 - ((3 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
17
normal! 0
tabedit massive.k.vs.t.py
set splitbelow splitright
wincmd t
set winheight=1 winwidth=1
argglobal
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 25 - ((15 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
25
...
exe 'vert 2resize ' . ((&columns * 84 + 78) / 157)
argglobal
vnoremap <buffer> 	 :py isort_visual()
xnoremap <buffer> <silent> \a} `>a}`<i{
xnoremap <buffer> <silent> \a{ `>a}`<i{
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 245 - ((33 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
245
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 65 + 78) / 157)
exe 'vert 2resize ' . ((&columns * 91 + 78) / 157)
argglobal
vnoremap <buffer> 	 :py isort_visual()
xnoremap <buffer> <silent> \a} `>a}`<i{
xnoremap <buffer> <silent> \a{ `>a}`<i{
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 333 - ((29 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
333
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 207 - ((26 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
207
...
exe 'vert 1resize ' . ((&columns * 65 + 78) / 157)
exe 'vert 2resize ' . ((&columns * 91 + 78) / 157)
tabedit build_massive_k.profiles.py
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 68 + 78) / 157)
...
wincmd w
argglobal
edit build_massive_k.profiles.py
vnoremap <buffer> 	 :py isort_visual()
xnoremap <buffer> <silent> \a} `>a}`<i{
xnoremap <buffer> <silent> \a{ `>a}`<i{
xnoremap <buffer> <silent> \a) `>a)`<i(
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 19 - ((13 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
19
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 29 - ((5 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
29
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 230 - ((22 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
230
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 32 - ((24 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
32
