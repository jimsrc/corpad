...
silent only
cd ~/simulacion/pla_stochastic/composite_turbulence/massive_orbits/scripts/analyze_err/atol
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 225 - ((17 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
225
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 39 - ((28 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
39
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 63 - ((19 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
63
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 64 - ((20 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
64
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 64 - ((32 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
64
