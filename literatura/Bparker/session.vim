...
silent only
cd ~/simulacion/pla_stochastic/composite_turbulence/massive_orbits/literatura/Bparker
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 86 + 63) / 127)
exe 'vert 2resize ' . ((&columns * 40 + 63) / 127)
argglobal
xnoremap <buffer> <silent> \a} `>a}`<i{
xnoremap <buffer> <silent> \a{ `>a}`<i{
xnoremap <buffer> <silent> \a) `>a)`<i(
