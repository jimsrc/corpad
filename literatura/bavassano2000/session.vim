...
silent only
cd ~/simulacion/pla_stochastic/composite_turbulence/massive_orbits/literatura/bavassano2000
...
silent! normal! zE
let s:l = 55 - ((25 * winheight(0) + 13) / 26)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 56 - ((24 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
56
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 61 - ((4 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
61
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 57 - ((26 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
57
