...
def calc_k_versus_t(dir_src, dir_out, dir_plots, 
	...
	dir_data= '%s/output_Ek.%2.1eeV/slab%1.1f/shalchi06' % (dir_src, Ek, slab_perc)
	fname_out = '%s/slab%1.2f/shalchi06/k_vs_t_Ek.%2.1eeV_slab%1.2f_LcShalchi06.dat' % (dir_out, slab_perc, Ek, slab_perc)
