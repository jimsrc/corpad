...
"""
def calc_k_versus_t(dir_src, dir_out, dir_plots, 
		Ek, Sig, NPLAS, NBs, nfil, ncol, Bo, Nm, slab_perc):
	dir_data= '%s/output_Ek.%2.1eeV/slab%1.1f/shalchi04' % (dir_src, Ek, slab_perc)
	fname_out = '%s/slab%1.1f/shalchi04/k_vs_t_Ek.%2.1eeV_slab%1.1f_LcShalchi04_%dBrlzs.dat' % (dir_out, slab_perc, Ek, slab_perc, NBs)
