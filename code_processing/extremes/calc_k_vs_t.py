...
"""
def calc_k_versus_t(Ek, Sig, NPLAS, NBs, nfil, ncol, Bo, Nm):
	dir_plots = '../../plots'
	dir_data= '../../output/output_Ek.%1.1eeV/sig.%.0e/Nm%d' % (Ek, Sig, Nm)
	fname_out = '../../post/sig.%.0e/Nm%d/k_vs_t_Ek.%1.1eeV_NB%d_NPLAS%d.dat' % (Sig, Nm, Ek, NBs, NPLAS)
...
def calc_k_versus_tt(Ek, Sig, NPLAS, NBs, nfil, ncol, Bo, Nm):
	dir_plots = '../../plots'
	dir_data= '../../output/output_Ek.%1.1eeV/sig.%.0e/Nm%d' % (Ek, Sig, Nm)
	fname_out = '../../post/sig.%.0e/Nm%d/k_vs_t_Ek.%1.1eeV_NB%d_NPLAS%d_.dat' % (Sig, Nm, Ek, NBs, NPLAS)
	...
	# nbad	: nro de files q solicite y no existen
	# time	: grilla temporal
	DATA, time, nok, nbad = load_trajectoriess(NBs, NPLAS, nfil, ncol, dir_data)
