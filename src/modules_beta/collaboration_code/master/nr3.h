...
#define _USESTDVECTOR_ 0
#define _USENRERRORCLASS_ 0
...
//cout << "fawefaerfae"<<endl;
//#define NRvector vector
//#else
//printf(" -----> definiendo NRvector...\n ");
template <class T>
class NRvector {
private:
...
if (i<0 || i>=nn) {
	...
	//printf(" NRvector subscript out of bounds!\n");
    //call_stack st;
    //cout << st.to_string();
}
//printf("NRvector!!!***\n");
